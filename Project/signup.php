...
<body>   
<h1 style="text-align:center;"><img src="images/logo.jpg" height="30px" width="130px"></h1>
<div class="container">
  ...
  <div class="form">
    ...
    <div class="sign-up" id="sign-up-info">
      ...
      <form id="sign-up-form" action="insert.php" method="POST">
        ...
        <input class="control-button up" type="submit" value="submit"/>
